...
function main()
{
    ...
    // Drawing rectangles
    // empieza a dibujarse de la esquina superior izquierda y el ultimo valor del rgba es el alfa que es la transparencia
    ...
    // limpia una parte del canvas/figura
    ctx.clearRect(45, 275, 60, 60);
    // hace un contorno/trazo
    ...
    ctx.lineTo(10, 50);
    // ctx.fill();
    // si es stroke es importante tener todos los puntos
    ctx.stroke();

    ctx.beginPath();
    ctx.fillStyle = 'rgba(120, 255, 0, 1.0)';
    ctx.arc(250, 300, 40, 0, Math.PI * 2, true); // Outer circle
    ctx.fill();
